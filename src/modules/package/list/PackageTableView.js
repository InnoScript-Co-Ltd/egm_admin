...
import { setPaginate } from "../packageSlice";
...
export const PackageTableView = () => {
    ...
    const columns = useRef(packagePayload.columns);
 ...
 */
    ...
    const loadingData = useCallback(async () => {
        setLoading(true);
        const response = await packageService.index(dispatch, paginateParams);
            ...
            <div className=' flex items-center justify-content-between'>
                ...
                <div className=' flex align-items-center gap-3'>
                    <Button
                        ...
                        size="small"
                        onClick={() => {
                            dispatch(setPaginate(packagePayload.paginateParams));
    ...
    return (
        ...
        >
            <DataTable
                ...
                globalFilterFields={packagePayload.columns}
