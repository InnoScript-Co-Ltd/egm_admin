...
export const transactionPayload = {
    ...
    columns: [
        ...
        { field: "agent_phone", header: "Agent Phone", sortable: true, show: true },
        { field: "agent_email", header: "Agent email", sortable: true, show: true },
        { field: "agent_nrc", header: "Agent NRC", sortable: true, show: true },
        { field: "agent_bank_branch", header: "Agent Bank Branch", sortable: true, show: true },
        { field: "agent_bank_address", header: "Agent Bank Address", sortable: true, show: true },
    ],
    paginateParams: {
        page: 1,
