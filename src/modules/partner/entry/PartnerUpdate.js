...
export const PartnerUpdate = () => {
  ...
  return (
    <div className="grid">
      ...
      <div className="col-12">
        <Card title="Update Partner Account Information">
            ...
            <div className="col-12 md:col-6 lg:col-6 py-3">
              <div className="flex flex-column justify-content-start align-items-start">
                ...
                <Image
                  ...
                  src={
                    payload.nrc_front
                      ? `${endpoints.image}/${payload.nrc_front}`
            ...
            <div className="col-12 md:col-6 lg:col-6 py-3">
              <div className="flex flex-column justify-content-start align-items-start">
                ...
                <Image
                  ...
                  src={
                    payload.nrc_back
                      ? `${endpoints.image}/${payload.nrc_back}`
                      : "https://primefaces.org/cdn/primereact/images/galleria/galleria12.jpg"
                  }
                  preview={true}
                  indicatorIcon={icon}
      ...
      {!loading && openConfirmDialog && (
        ...
        >
          <p className="mb-3">
            {dialogId === "account"
              ? "Are you sure approve ACTIVE status to this account?"
              : "Are you sure approve FULL_KYC status to this account?"}
          </p>
