...
export const MerchantBankAccountUpdate = () => {
  ...
  const { merchantBankAccount } = useSelector(
    (state) => state.merchantBankAccount
  );
  const transactionLimitStatus = [
        ...
        >
          ...
          <div className="grid">
            <div className="col-12 md:col-3 lg:col-3 py-3">
              <label htmlFor="holder_name" className="input-label">
                {" "}
                Holder Name{" "}
              </label>
            ...
            <div className="col-12 md:col-3 lg:col-3 py-3">
              <label htmlFor="account_number" className="input-label">
                {" "}
                Account Number{" "}
              </label>
              <div className="p-inputgroup mt-2">
            ...
            <div className="col-12 md:col-3 lg:col-3 py-3">
              <div className="flex flex-column gap-2">
                <label htmlFor="status" className="input-label text-black">
                  {" "}
                  Bank Type{" "}
                </label>
                <Dropdown
            ...
            <div className="col-12 md:col-3 lg:col-3 py-3">
              <label htmlFor="transaction_limit" className="input-label">
                {" "}
                Account Number{" "}
              </label>
              <div className="p-inputgroup mt-2">
                <InputText
                  ...
                  className="p-inputtext-sm"
                  aria-describedby="transaction-limit-help"
                  placeholder="Enter Transaction Limit"
                  value={
                    payload.transaction_limit ? payload.transaction_limit : ""
                  }
                  tooltip="Transaction Limit"
                  tooltipOptions={{ ...tooltipOptions }}
                  disabled={loading}
                  onChange={(e) =>
                    payloadHandler(
              ...
              <ValidationMessage field="transaction_limit" />
            </div>

            <div className="col-12 md:col-3 lg:col-3 py-3">
              <div className="flex flex-column gap-2">
                <label
                  htmlFor="transaction_limit_status"
                  className="input-label text-black"
                >
                  {" "}
                  Transaction Limit Status{" "}
                </label>
                <Dropdown
                  className="p-inputtext-sm"
                  inputId="transaction_limit_status"
                  name="transaction_limit_status"
                  options={transactionLimitStatus}
                  placeholder="Select Merchant Bank Account Status"
                  disabled={loading}
                  value={
                    payload.transaction_limit_status
                      ? payload.transaction_limit_status
                      : ""
                  }
                  onChange={(e) =>
                ...
                />
                <ValidationMessage field={"transaction_limit_status"} />
              </div>
            </div>
