                ...
                >
                    ...
                    <div className="grid">
                        ...
                        <div className="col-12 md:col-4 lg:col-4 py-3">
                            <label htmlFor="name" className='input-label text-black'>{"Bank Account Holder Name"} <span>(required*)</span></label>
                        ...
                        <div className="col-12 md:col-4 lg:col-4 py-3">
                            <label htmlFor="email" className='input-label text-black'>{"Bank Account Number"} <span>(required*)</span> </label>
                            <div className="p-inputgroup mt-2">
                                <InputText
                                    id="account_number"
                                    name="account_number"
